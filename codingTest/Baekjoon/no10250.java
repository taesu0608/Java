...
1 초	256 MB	223172	77154	65159	33.499%
문제
...
를 들면 102 호 방보다는 301 호 방을 더 선호하는데, 102 호는 거리 2 만큼 걸어야 하지만 301 호는 거리 1 만큼만 걸으면 되기 때문이다.
...
public class no10250 {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < loop; i++) {
            ...
            int ch = n%h==0?h:n%h;
            //호수
            int cw = (n%h==0?0:1) + (n/h==0?0:n/h);
            if(0<cw && cw < 10){
                System.out.println(ch+"0"+cw);
            }
            else System.out.println(ch+""+cw);
        }
    }
}
